...
import { Upload, Plus, LogOut, LayoutDashboard, Image as ImageIcon, Users } from 'lucide-react';
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <aside className="w-64 bg-primary-900 text-white p-6 hidden md:block">
                ...
                <nav className="space-y-2">
                    <Link to="/admin/dashboard" className="flex items-center gap-3 p-3 bg-white/10 rounded-lg text-gold-400 font-medium">
                        <LayoutDashboard size={20} /> Dashboard
                    </Link>
                    {/* Future: Add Applications Link */}
            ...
            <main className="flex-1 p-8 overflow-y-auto">
                <h1 className="text-3xl font-heading font-bold text-primary-900 mb-8">Content Management</h1>
