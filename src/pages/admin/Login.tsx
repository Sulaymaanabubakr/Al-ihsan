            ...
            <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div className="mt-6">
                    ...
                    <button
                        ...
                        className="mt-6 w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-gray-700"
                    >
